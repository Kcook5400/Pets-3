	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(act == null) {
			...
			try {
				...
				AppointmentList listToDelete = dao.searchForListDetailsById(tempId);
				dao.deleteAppointment(listToDelete);
				...
				try {
					Integer tempId = Integer.parseInt(request.getParameter("id"));
					AppointmentList listToEdit = dao.searchForListDetailsById(tempId);
					...
					PetHelper daoForItems = new PetHelper();
